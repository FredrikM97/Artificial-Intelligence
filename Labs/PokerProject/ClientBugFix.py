...
SIGNAL_ALIVE = ''#'==================ALIVE======================'
# Added for nicer debugging to actually see rounds
SIGNAL_START =  '\n==================Start round=================='
SIGNAL_END =    '*******************End round*******************\n'
...
while GAME_ON:
    ...
    try:             
        ...
        while len(MsgFractions):
            ...
            # TODO Probably not needed anymore because above
            ...
            RequestType = MsgFractions.pop(0)
            ...
            # * Append space, the players name, space and the amount of chips after this string. Separate the words by space. */
                ...
                name = MsgFractions.pop(0)
                if name == POKER_CLIENT_NAME:
                    chips = MsgFractions.pop(0)
                    infoAgent.Chips = int(chips)
                    # SMART start
                    infoPlayerChips(name, chips)
                    # SMART end
                else:
                    infoPlayerChips(name, MsgFractions.pop(0))
            ...
            # * Append the players name and the bet value after this string. Separate the words by space. */
                ...
                if name == POKER_CLIENT_NAME:
                    print(SIGNAL_START)
                    infoAgent.playersCurrentBet = infoAgent.playersCurrentBet + int(MsgFractions.pop(0))
                else:
                    infoForcedBet(name, MsgFractions.pop(0))
            ...
            # * Separate the words by space. */
                ...
                minimumPotAfterOpen = int(MsgFractions.pop(0))
                playersCurrentBet = int(MsgFractions.pop(0))
                playerRemainingChips = int(MsgFractions.pop(0))
                ...
                maximumBet = int(MsgFractions.pop(0))
                minimumAmountToRaiseTo = int(MsgFractions.pop(0))
                playersCurrentBet = int(MsgFractions.pop(0))
                playersRemainingChips = int(MsgFractions.pop(0))
                ...
                for ielem in range(1,6): # 1 based indexing is required...
                    infoAgent.CurrentHand.append(MsgFractions.pop(0))
            ...
            # * Append space and the round number after this string. */
                ...
                infoNewRound(MsgFractions.pop(0))
            ...
            # * Separate the words by space. */
                ...
                infoPlayerOpen(MsgFractions.pop(0), MsgFractions.pop(0))
            ...
            # * Append the players name after this string. Separate the words by space. */
                ...
                infoPlayerCheck(MsgFractions.pop(0))
            ...
            # * Append the players name and the number of cards exchanged after this string. Separate the words by space. */
                ...
                infoPlayerDraw(MsgFractions.pop(0), MsgFractions.pop(0))
            ...
            # * Append the players name and the amount of chips the player won after the string. Separate the words by space. */
                ...
                print(SIGNAL_END)
                infoRoundUndisputedWin(MsgFractions.pop(0), MsgFractions.pop(0))
            ...
            # * Append the players name and the amount of chips the player won after the string. Separate the words by space. */
                ...
                print(SIGNAL_END)
                infoRoundResult(MsgFractions.pop(0),MsgFractions.pop(0))
            ...
            # * Append the players name and the cards of the players hand after this string. Separate the words by space.*/
                ...
                infoPlayerHand(MsgFractions.pop(0), [MsgFractions.pop(0),MsgFractions.pop(0),MsgFractions.pop(0),MsgFractions.pop(0),MsgFractions.pop(0)])
