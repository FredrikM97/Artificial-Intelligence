...
* @param round the round number (increased for each new round).
'''
def infoNewRound(msg, verbose=False, **kwargs):
    #_nrTimeRaised = 0
    _round, *_ = msg
    if verbose:
...
'''
def infoPlayerOpen(msg, verbose=False, **kwargs):
...
'''
def infoPlayerCheck(msg, verbose=False, **kwargs):
    _playerName, *_ = msg
    if verbose:
...
'''
def infoPlayerCall(msg, verbose=False, **kwargs):
    _playerName, *_ = msg
    if verbose:
...
'''
def infoPlayerFold(msg, verbose=False, **kwargs):
    _playerName, *_ = msg
    if verbose:
...
'''
def infoPlayerChips(msg, verbose=False, **kwargs):
...
'''
def infoPlayerAllIn(msg, verbose=False, **kwargs):
...
'''
def infoPlayerHand(msg, verbose=False, **kwargs):
...
'''
def infoPlayerRise(msg, verbose=False, **kwargs):
