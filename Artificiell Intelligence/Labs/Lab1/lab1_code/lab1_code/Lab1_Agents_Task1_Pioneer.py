...
while robot: # main Control loop
    ...
    distanceX1 = (World.getSensorReading('ultraSonicSensorMoreRight')-1.5)
    distanceY1 = (World.getSensorReading('ultraSonicSensorMoreLeft')-1.5)
    ...
    #if distanceX > minDistance and distanceY > minDistance:
    motorSpeed = dict(speedLeft=(speed+0.2), speedRight=speed)
    ...
    #World.execute(motorSpeed, executeTime,-1)
